...
Route::group(['prefix'     => 'doctors', 'as' => 'doctors.', 'middleware' => ['auth', 'xss', 'checkUserStatus', 'role:doctor'],
    ...
    function () {
        ...
        Route::get('live-consultation-list', 'LiveConsultationController@getTypeNumber')->name('live.consultation.list');
        Route::post('live-consultation/change-status', [LiveConsultationController::class, 'getChangeStatus'])->name('live.consultation.change.status');
        ...
        Route::get('live-consultation/{liveConsultation}', 'LiveConsultationController@show')->name('live.consultation.show');
        Route::get('user-zoom-credential/{userZoomCredential}/fetch', 'LiveConsultationController@zoomCredential')->name('zoom.credential');
        Route::post('user-zoom-credential', 'LiveConsultationController@zoomCredentialCreate')->name('zoom.credential.create');
    });
