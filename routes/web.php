...
Route::get('sync-google-calendar-list', [GoogleCalendarController::class, 'syncGoogleCalendarList'])->name('syncGoogleCalendarList');
Route::get('google/redirect', [GoogleCalendarController::class, 'redirect']);
Route::post('create-google-calendar-patient', [AppointmentController::class, 'createGoogleEventForPatient'])->name('createGoogleEventForPatient');
Route::post('create-google-calendar-doctor', [AppointmentController::class, 'createGoogleEventForDoctor'])->name('createGoogleEventForDoctor');
...
//Stripe route
Route::get('/medical-payment-success', [AppointmentController::class, 'paymentSuccess'])->name('medical-appointment-payment-success');
Route::get('/medical-payment-failed', [AppointmentController::class, 'handleFailedPayment'])->name('medical-appointment-failed-payment');
