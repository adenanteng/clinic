...
class TreatmentCategory extends Model
{
    ...
    public function activatedTreatment(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(Treatment::class,'category_id')->where('status',Service::ACTIVE);
    }
