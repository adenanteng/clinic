        ...
        columns: [
            ...
            },
            {
                data: function (row) {
                    ...
                    <div class="d-inline-block align-top">
                        <a href="${(adminRole == true) ? route('patients.show', row.patient.patient_unique_id) : url}"
            ...
            },
            {
                data: function (row) {
                    return `<div class="badge badge-light-info">
                                ...
                                <div class="">${moment(row.date).format('Do MMM, Y ')}</div>
                            </div>`;
                },
                name: 'date',
            },
                ...
                data: function (row) {
                    return `
                        <select class="form-select-sm form-select-solid form-select change-payment-status payment-status" data-id="${row.id}">
                            <option value="${paid}" ${(row.payment_type == paid) ? 'selected' : ''}>Paid</option>
                            <option value="${pending}" ${(row.payment_type == paid) ? 'disabled' : 'selected'}>Pending</option>
                        </select>`;
                },
                name: 'payment_type',
            },
