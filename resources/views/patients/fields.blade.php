<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6 mb-5">
        ...
        {{ Form::select('nric_type', $data['nricGroupList'] ,!empty($patient->user) ? $patient->user->nric_type : null, ['placeholder' => 'Pilih Kartu Identitas','class' => 'form-select form-select-solid form-select-lg fw-bold', 'aria-label'=>"Pilih Agama",'data-control'=>'select2']) }}
    </div>
    <div class="col-md-6 mb-5">
        {{ Form::label('nricId',__('messages.patient.nric_id').':' ,['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3 required']) }}
        {{ Form::number('nric_id',!empty($patient->user) ? $patient->user->nric_id : null,['class' => 'form-control form-control-solid','placeholder' => 'Nomor Kartu Identitas','required']) }}
    </div>
    <div class="col-md-6 mb-5">
        {{ Form::label('fullName',__('messages.patient.name').':' ,['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3 required']) }}
        {{ Form::text('full_name',!empty($patient->user) ? $patient->user->first_name : null,['class' => 'form-control form-control-solid','placeholder' => 'Name','required']) }}
    </div>
{{--    <div class="col-md-6 mb-5">--}}
...
{{--    </div>--}}
    ...
    <div class="col-md-6 mb-5">
        <label class="form-label fs-6 fw-bolder text-gray-700 mb-2">{{ __('messages.patient.gender').':' }}</label>
        {{ Form::select('gender', $data['genderGroupList'] ,!empty($patient->user) ? $patient->user->gender : null, ['placeholder' => 'Pilih Gender','class' => 'form-select form-select-solid form-select-lg fw-bold', 'aria-label'=>"Pilih Status Pernikahan",'data-control'=>'select2']) }}
    </div>
    <div class="col-md-6 mb-5">
        <label class="form-label fs-6 fw-bolder text-gray-700 mb-2">{{ __('messages.patient.marriage').':' }}</label>
        {{ Form::select('marriage', $data['marriageGroupList'] ,!empty($patient->user) ? $patient->user->marriage : null, ['placeholder' => 'Pilih Status Pernikahan','class' => 'form-select form-select-solid form-select-lg fw-bold', 'aria-label'=>"Pilih Status Pernikahan",'data-control'=>'select2']) }}
    </div>
    <div class="col-md-6 mb-5">
        <label class="form-label fs-6 fw-bolder text-gray-700 mb-2">{{ __('messages.patient.religion').':' }}</label>
        {{ Form::select('religion', $data['religionGroupList'] ,!empty($patient->user) ? $patient->user->religion : null, ['placeholder' => 'Pilih Agama','class' => 'form-select form-select-solid form-select-lg fw-bold', 'aria-label'=>"Pilih Agama",'data-control'=>'select2']) }}
    </div>
    <div class="col-md-6 mb-5">
...
{{--    </div>--}}
    <div class="d-flex col-md-6 flex-column mb-7 fv-row visually-hidden">
        ...
        {{ Form::select('country_id', $data['countries'] , null, ['id' => 'countryId','data-placeholder' => 'Select Country','class' => 'form-select form-select-solid form-select-lg fw-bold', 'aria-label'=>"Select a Country", 'data-control'=>'select2']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('state_id',__('messages.state.state').':',['class'=>'form-label fs-6 fw-bolder text-gray-700 mb-2']) }}
        {{ Form::select('state_id', [], null, ['id' => 'stateId','class' => 'form-select form-select-solid form-select-lg fw-bold','data-placeholder' => 'Select State','aria-label'=>"Select State",'data-control'=>'select2']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('city_id',__('messages.city.city').':',['class'=>'form-label fs-6 fw-bolder text-gray-700 mb-2']) }}
        {{ Form::select('city_id', [], null, ['id' => 'cityId','class' => 'form-select form-select-solid form-select-lg fw-bold', 'data-placeholder' => 'Select City','aria-label'=>"Select City",'data-control'=>'select2']) }}
    </div>
