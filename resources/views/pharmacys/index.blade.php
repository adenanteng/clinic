        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                <div class="card-header d-flex border-0 pt-6">
                    ...
                    <div class="card-toolbar ms-sm-auto ms-0">
...
{{--                                            </div>--}}
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    {{ Form::select('status', $appointmentStatus, \App\Models\Pharmacy::PRESCRIPTION_STATUS,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id' => 'appointmentStatus']) }}
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end">
                                ...
                                <div class="d-flex align-items-center my-sm-0 my-1 align-self-sm-center">
                                    <a type="button" class="btn btn-primary" href="{{ route('pharmacys.create')}}">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <rect fill="#000000" x="4" y="11" width="16" height="2" rx="1"/>
                                            <rect fill="#000000" opacity="0.5" transform="translate(12.000000, 12.000000) rotate(-270.000000) translate(-12.000000, -12.000000)" x="4" y="11" width="16" height="2" rx="1"/>
                                        </svg>
                                    </span>{{ __('messages.pharmacy.add') }}</a>
                                </div>
                        </div>
                    </div>
                </div>
